...
const teamMembers = [
  ...
  },
  {
    ...
    image: "https://miro.medium.com/v2/resize:fit:2400/1*pyprQ9zXLGlVqYBvs7jz_w@2x.jpeg", // Placeholder image URL
  },
...
const TeamPage = () => {
  return (
    <section id="team" className="mx-auto max-w-screen-2xl px-4  sm:px-6 lg:px-8 lg:py-16">
      <div className="flex justify-center"> {/* Centering the grid */}
        <div className="">
          <h2 className="text-3xl font-bold text-center mb-12 ">Our Team</h2>
          {/* Team Member Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {teamMembers.map((member, index) => (
              <div key={index} className="team-member bg-white rounded-lg shadow-md w-80 transition duration-300 ease-in-out transform hover:scale-105">
                <Card className="py-4">
