  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        <div className="absolute top-1/2 -right-48 w-96 h-96 bg-indigo-100 rounded-full opacity-20"></div>
        <div className="absolute -bottom-24 left-1/4 w-64 h-64 bg-purple-100 rounded-full opacity-20"></div>
      </div>

      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Section header */}
        <div className="text-center mb-20">
          <h3 className="mt-2 text-5xl font-extrabold text-gray-900 tracking-tight">Meet Our Experts</h3>
          <p className="mt-4 max-w-3xl mx-auto text-xl text-gray-500">
            Passionate professionals dedicated to revolutionizing the industry with cutting-edge solutions.
          </p>
        </div>
          ...
          {teamMembers.map((member, index) => (
            ...
            >
              ...
              <div className="relative w-48 h-48 md:w-64 md:h-64 flex-shrink-0 overflow-hidden rounded-2xl shadow-xl transition-all duration-300 group-hover:translate-y-2 group-hover:shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-tr from-indigo-500 to-purple-600 opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
                <img
                  src={member.image}
                  alt={member.name}
              ...
              <div className="flex flex-col items-center md:items-start">
                ...
                <p className="mt-1 text-lg font-medium text-indigo-600">{member.position}</p>
                
                <p className="mt-4 text-gray-600 text-center md:text-left">{member.bio}</p>
                
                <div className="mt-6 flex items-center gap-4">
                  <span className="px-4 py-2 bg-gray-100 rounded-full text-sm text-gray-700 font-medium">
                    <span className="font-light">Contact:</span> {member.contact}
                  </span>
        ...
        <div className="mt-24 text-center">
          <div className="inline-flex items-center p-1 px-1 pr-4 bg-gray-100 rounded-full">
            <span className="px-3 py-0.5 text-sm text-white font-semibold bg-indigo-600 rounded-full">Join Us</span>
            <span className="ml-4 text-sm font-medium text-gray-600">We're always looking for new community members</span>
          </div>
          <a
            href="#contact"
