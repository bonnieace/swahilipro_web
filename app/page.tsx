...
<section className="overflow-hidden  sm:grid sm:grid-cols-2 sm:items-center">
  <div className="p-8 md:p-12 lg:px-16 lg:py-24">
    <div className="mx-auto max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
      ...
      Swahilipro is a compiler for a Swahili-based programming language that allows Swahili speakers to write executable code in their native language.
...
<section className="">
  <div id='About' className="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 md:py-16 lg:px-8">
    <div className="mx-auto max-w-3xl text-center">
      <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">Trusted by programmers globally</h2>
    ...
    <div className="mt-8 sm:mt-12">
      <dl className="grid grid-cols-1 gap-4 sm:grid-cols-3 sm:divide-x sm:divide-gray-100">
        <div className="flex flex-col px-4 py-8 text-center">
          <dt className="order-last text-lg font-medium text-gray-500">Total Active Users</dt>

          <dd className="text-4xl font-extrabold text-emerald-600 md:text-5xl">10+</dd>
        </div>

        <div className="flex flex-col px-4 py-8 text-center">
          <dt className="order-last text-lg font-medium text-gray-500">Website Visits</dt>

          <dd className="text-4xl font-extrabold text-emerald-600 md:text-5xl">100+</dd>
        </div>

        <div className="flex flex-col px-4 py-8 text-center">
          <dt className="order-last text-lg font-medium text-gray-500">Collaborators</dt>

          <dd className="text-4xl font-extrabold text-emerald-600 md:text-5xl">5</dd>
        </div>
      </dl>
    </div>
  </div>
</section>
  <div id='features' className=" mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    <div className="grid grid-cols-1 gap-y-8 lg:grid-cols-2 lg:items-center lg:gap-x-16">
      <div className="mx-auto max-w-lg text-center lg:mx-0 ltr:lg:text-left rtl:lg:text-right">
        <h2 className="text-3xl font-bold sm:text-4xl">Explore some programming features</h2>

        <p className="mt-4 text-gray-600">
          The swahilipro compiler supports several programming features similar with popular programming languages.This features allow users to create complex algorithms in swahili.
        </p>
    ...
    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h16"></path>
          ...
          <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
            Users can create swahili scripts in any IDE,save them with .swa extension and execute them.
          </p>
        </a>
        ...
        >
          <span className="inline-block rounded-lg bg-gray-50 p-3">
    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M6 9V2h12v7M6 14h12v8H6v-8zm6 8v-4"></path>
    </svg>
</span>
          ...
          <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
            Users can read input, process it and print output that they understand.
          </p>
        </a>
      ...
      <span className="inline-block rounded-lg bg-gray-50 p-3">
    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 3v4a1 1 0 001 1h8a1 1 0 001-1V3m-6 10v4m-4 0h8"></path>
    </svg>
</span>
          ...
          <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
          The compiler allows users to store data in variables and manipulate them in Algorithms.
          </p>
        </a>
       ...
       <span className="inline-block rounded-lg bg-gray-50 p-3">
    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 5l14 14M5 19L19 5"></path>
    </svg>
</span>
          ...
          <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
            Users can perform arithmetic operations like add ,subtract,multiply and divide.
          </p>
        </a>
        ...
        >
          <span className="inline-block rounded-lg bg-gray-50 p-3">
    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 9l3 3-3 3m0-6h4a2 2 0 012 2v4"></path>
    </svg>
</span>
          ...
          <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
            Swahilipro supports conditional operations including if and for loops.
          </p>
        </a>
        ...
        >
         <span className="inline-block rounded-lg bg-gray-50 p-3">
    <svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 2v2M12 20v2M2 12h2M20 12h2M16.24 7.76l1.42-1.42M5.34 18.66l1.42-1.42M7.76 7.76l-1.42-1.42M18.66 18.66l-1.42-1.42M12 4a8 8 0 100 16 8 8 0 000-16z"></path>
    </svg>
</span>
          ...
          <p className="hidden sm:mt-1 sm:block sm:text-sm sm:text-gray-600">
            Users can define custom functions and call them to perform different tasks.
          </p>
        </a>
      </div>
    </div>
...
<section className="">
  <div id='Reviews' className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
    ...
    <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-3">
      <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
        <div>
          ...
          <div className="mt-4">
            <p className="text-2xl font-bold text-rose-600 sm:text-3xl">Genius Idea!!</p>
      ...
      <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
        <div>
          ...
          <div className="mt-4">
            <p className="text-2xl font-bold text-rose-600 sm:text-3xl">Awesome</p>
      ...
      <blockquote className="flex h-full flex-col justify-between bg-white p-6 shadow-sm sm:p-8">
        <div>
          ...
          <div className="mt-4">
            <p className="text-2xl font-bold text-rose-600 sm:text-3xl">Incredible.</p>
